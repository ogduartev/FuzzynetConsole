...
wxString Ranking::descripcion()
{
  ...
  Desc << wxT("La expresión general es la siguiente:\n");
  Desc << wxT("Si orden > 0 \n");
  Desc << wxT("    f(x1,x2,...,xn)=(Posicion - 0.5)/n\n");
  Desc << wxT("    Pos = n - número de valores x2, x3, ... ,xn mayores que x1\n");
  Desc << wxT("Si orden < 0 \n");
  Desc << wxT("    f(x1,x2,...,xn)= 1 - (Pos - 0.5)/n\n");
  Desc << wxT("    Pos = n - número de valores x2, x3, ... ,xn mayores que x1\n");
  Desc << wxT("El resultado está entre 1/2n y 1 - 1/2n \n");
  return Desc;
}
...
wxString Ranking::descripcionLatex()
{
  ...
  Desc << wxT("Si $orden > 0$ :\n");
  Desc << wxT("\\[");
  Desc << wxT("f(x_1,x_2,\\cdots,x_n)=\\frac{Pos - 0.5}{n}");
  Desc << wxT("\\]\n");
  Desc << wxT("\\[");
  ...
  Desc << wxT("Si $orden < 0$ :\n");
  Desc << wxT("\\[");
  Desc << wxT("f(x_1,x_2,\\cdots,x_n)=1 - \\frac{Pos - 0.5}{n}");
  Desc << wxT("\\]\n");
  Desc << wxT("\\[");
  Desc << wxT("Pos = n - \\text{n\\'umero de valores } x_2, x_3, \\cdots ,x_n \\text{ mayores que } x_1");
  Desc << wxT("\\]\n");
  Desc << wxT("El resultado está entre $\\frac{1}{2n}$ y $1 - \\frac{1}{2n}$ \n");
  return Desc;
}
